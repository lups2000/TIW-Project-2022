...
public class UserDAO {
	...
	public void registerUser(String name,String surname,String username,String password,String email) throws SQLException {
		
		//query prepared
		String query="INSERT INTO dbprogetto.utente (username,password,nome,cognome,email) VALUES(?,?,?,?,?)";
		try(PreparedStatement preparedStatement=connection.prepareStatement(query)){
			preparedStatement.setString(1, username);
